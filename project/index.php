...
<head>
    ...
    <title>Project Page - Connor Wallace</title>
        ...
        <div class="container"><a class="navbar-brand logo" href="#">Connor Wallace</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navbarNav"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="/about.php">About Me</a></li>
                </ul>
            </div>
        </div>
    </nav>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 offset-md-1 info">
                        ...
                        <div class="d-flex justify-content-center align-items-center content"><button class="btn btn-outline-primary btn-lg" type="button">View On Github</button></div>
                    </div>
                    <div class="col-12 col-md-4 col-lg-3 offset-md-1 meta">
                ...
                <div class="project-progress">
                    <h3 class="text-center">Project Progress</h3>
                    <div class="row py-3">
