                    ...
                    <div class="item">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <h4 class="organization">BerkleyNet</h4>
                            </div>
                            <div class="col-md-6"><span class="period">05/2017 - 08/2019</span></div>
                        </div>
                        <p class="text-muted">Worked on a team to develop and test software and build backend services (Java, SQL). Gained experience in team-oriented software development and business software development practices (Agile, Atlassian / Jira, Bitbucket).</p>
                    </div>
                    <div class="item">
                        <div class="row">
                            <div class="col-md-6">
                                <h3><strong>ROTC Battalion Communications and Network Staff</strong></h3>
                                <h4 class="organization">JMU Army ROTC</h4>
                            </div>
                            <div class="col-md-6"><span class="period">01/2019 - 01/2020</span></div>
                        </div>
                        <p class="text-muted">Acted as the Communication and Network head in the JMU Army ROTC Battalion. Handled network troubleshooting and solved communication and technical problems.</p>
                    </div>
                </div>
                <div class="education group">
                    ...
                    <div class="item">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <h4 class="organization">James Madison University</h4>
                            </div>
                            <div class="col-6"><span class="period">08/2016 - 05/2020</span></div>
                        </div>
                    ...
                    <div class="item">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>High School</h3>
                                <h4 class="organization">Forest Park Senior High School</h4>
                            </div>
                            <div class="col-md-6"><span class="period">08/2012 - 06/2016</span></div>
                        </div>
                        <p class="text-muted">Graduated with an advanced diploma. Participated in Computer Science program for all 4 years of High School</p>
                    </div>
                </div>
                <div class="group">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="contact-info portfolio-info-card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9"><span>Connor Wallace</span></div>
                                </div>
                                <div class="row">
                                    <div class="col-1"><i class="icon ion-android-calendar icon"></i></div>
                                    <div class="col-9"><span>05/14/1998</span></div>
                                </div>
                                <div class="row">
                                    <div class="col-1"><i class="icon ion-android-map icon"></i></div>
                                    <div class="col-9"><span>Woodbridge, Virginia</span></div>
                                </div>
                                <div class="row">
                                    <div class="col-1"><i class="icon ion-at icon"></i></div>
                                    <div class="col-9"><span>connorjwallace@outlook.com</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
